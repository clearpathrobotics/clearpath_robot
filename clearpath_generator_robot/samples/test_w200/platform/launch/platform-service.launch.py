...
def generate_launch_description():
    ...
    launch_arg_diagnostic_updater_params = DeclareLaunchArgument(
        ...
        default_value='/home/lcamero/Workspaces/sample_ws/src/clearpath_robot/clearpath_generator_robot/samples/test_w200/platform/config/diagnostic_updater.yaml',
        description='')
    ...
    launch_arg_diagnostic_aggregator_params = DeclareLaunchArgument(
        ...
        default_value='/home/lcamero/Workspaces/sample_ws/src/clearpath_robot/clearpath_generator_robot/samples/test_w200/platform/config/diagnostic_aggregator.yaml',
        description='')
    ...
    launch_arg_foxglove_bridge_parameters = DeclareLaunchArgument(
        ...
        default_value='/home/lcamero/Workspaces/sample_ws/src/clearpath_robot/clearpath_generator_robot/samples/test_w200/platform/config/foxglove_bridge.yaml',
        description='')
    ...
    launch_arg_imu_filter = DeclareLaunchArgument(
        'imu_filter',
        default_value='/home/lcamero/Workspaces/sample_ws/src/clearpath_robot/clearpath_generator_robot/samples/test_w200/platform/config/imu_filter.yaml',
        description='')
        ...
        launch_arguments=
            [
                (
                    'setup_path'
                    ,
                    '/home/lcamero/Workspaces/sample_ws/src/clearpath_robot/clearpath_generator_robot/samples/test_w200'
                )
                ,
                (
                    'use_sim_time'
