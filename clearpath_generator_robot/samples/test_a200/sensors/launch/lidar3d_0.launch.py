        ...
        launch_arguments=
            [
                (
                    'parameters'
                    ,
                    '/home/lcamero/Workspaces/jazzy_ws/src/clearpath_robot/clearpath_generator_robot/samples/test_a200/sensors/config/lidar3d_0.yaml'
                )
                ,
                (
                    'namespace'
                    ,
                    'a201_0000/sensors/lidar3d_0'
                )
                ,
                (
                    'robot_namespace'
