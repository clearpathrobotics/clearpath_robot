        ...
        launch_arguments=
            [
                (
                    'parameters'
                    ,
                    '/home/lcamero/Workspaces/jazzy_ws/src/clearpath_robot/clearpath_generator_robot/samples/test_a200/sensors/config/camera_1.yaml'
                )
                ,
                (
                    'namespace'
                    ,
                    'a201_0000/sensors/camera_1'
                )
                ,
                (
                    'robot_namespace'
