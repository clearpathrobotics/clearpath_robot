...
def generate_launch_description():
    ...
    launch_arg_diagnostic_updater_params = DeclareLaunchArgument(
        ...
        default_value='/home/lcamero/Workspaces/jazzy_ws/src/clearpath_robot/clearpath_generator_robot/samples/test_do150/platform/config/diagnostic_updater.yaml',
        description='')
    ...
    launch_arg_diagnostic_aggregator_params = DeclareLaunchArgument(
        ...
        default_value='/home/lcamero/Workspaces/jazzy_ws/src/clearpath_robot/clearpath_generator_robot/samples/test_do150/platform/config/diagnostic_aggregator.yaml',
        description='')
    ...
    launch_arg_foxglove_bridge_parameters = DeclareLaunchArgument(
        ...
        default_value='/home/lcamero/Workspaces/jazzy_ws/src/clearpath_robot/clearpath_generator_robot/samples/test_do150/platform/config/foxglove_bridge.yaml',
        description='')
    ...
    launch_arg_imu_filter = DeclareLaunchArgument(
        'imu_filter',
        default_value='/home/lcamero/Workspaces/jazzy_ws/src/clearpath_robot/clearpath_generator_robot/samples/test_do150/platform/config/imu_filter.yaml',
        description='')
        ...
        launch_arguments=
            [
                (
                    'setup_path'
                    ,
                    '/home/lcamero/Workspaces/jazzy_ws/src/clearpath_robot/clearpath_generator_robot/samples/test_do150'
                )
                ,
                (
                    'use_sim_time'
    ...
    node_puma_control = Node(
        ...
        parameters=
            [
                '/home/lcamero/Workspaces/jazzy_ws/src/clearpath_robot/clearpath_generator_robot/samples/test_do150/platform/config/control.yaml'
                ,
            ]
        ,
    )
